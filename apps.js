...
function setupEventListeners() {
    ...
    document.querySelectorAll('.sidebar-menu a[data-page]').forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            if (page === 'financialReports' || page === 'auditLogs' || page === 'systemSettings') {
...
function loadDashboardData() {
    ...
    const statCard1 = document.querySelector('.stat-card-1 h3');
    if (statCard1) {
    ...
    const statCard2 = document.querySelector('.stat-card-2 h3');
    if (statCard2) {
    ...
    const statCard3 = document.querySelector('.stat-card-3 h3');
    if (statCard3) {
    ...
    const statCard4 = document.querySelector('.stat-card-4 h3');
    if (statCard4) {
